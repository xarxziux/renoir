module.exports = {
    ...
    rules: {
        ...
        'func-call-spacing': 'off', //['error', 'always', {allowNewlines: true}],
        ...
        'space-before-function-paren': ['error', 'always'], // require or disallow space before function opening parenthesis (off by default)
        // 'space-in-brackets': ['warn', 'never'], // require or disallow spaces inside brackets (off by default)
        ...
        // 'space-return-throw-case': ['warn', 'always'], // require a space after return, throw, and case
        ...
        'max-len': ['error', 78], // specify the maximum length of a line in your program (off by default)
