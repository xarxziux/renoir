...
var _numberDetect2 = _interopRequireDefault(_numberDetect);

var _utils = require('./utils.mjs');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var typeOf = _numberDetect2.default.numberDetect;
...
var getSequentialArray = exports.getSequentialArray = function getSequentialArray(arrSize) {
    ...
    return typeOf(arrSize) !== 'number' || typeOf(step) !== 'number' || typeOf(firstValue) !== 'number' ? (0, _utils.throwError)('getSequentialArray: invalid parameter(s)') : getBlankArray(arrSize).map(function (_, i) {
        return firstValue + i * step;
    });
};

},{"./utils.mjs":8,"number-detect":1}],4:[function(require,module,exports){
/** @format */
...
},{"./utils.mjs":8}],5:[function(require,module,exports){
"use strict";
...
},{"./utils.mjs":8}],7:[function(require,module,exports){
'use strict';
...
var _either = require('./either.mjs');
...
},{"./either.mjs":4,"number-detect":1}],8:[function(require,module,exports){
/** @format */
...
var _utils = require('./core/utils.mjs');

var _array = require('./core/array.mjs');

var _either = require('./core/either.mjs');

var _trampoline = require('./core/trampoline.mjs');

var _type_check = require('./core/type_check.mjs');

var _objects = require('./core/objects.mjs');
...
},{"./core/array.mjs":3,"./core/either.mjs":4,"./core/objects.mjs":5,"./core/trampoline.mjs":6,"./core/type_check.mjs":7,"./core/utils.mjs":8}]},{},[9]);
